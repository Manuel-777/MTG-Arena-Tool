...
function createUpdaterWindow() {
  ...
  win.loadURL(formatUrl({
    pathname: path.join(__dirname, 'window_updater/index.html'),
    protocol: 'file',
    slashes: true,
  }));
...
function createBackgroundWindow() {
  ...
  win.loadURL(formatUrl({
    pathname: path.join(__dirname, 'window_background/index.html'),
    protocol: 'file',
    slashes: true,
  }));
...
function createOverlayWindow() {
  ...
  overlay.loadURL(formatUrl({
    pathname: path.join(__dirname, 'window_overlay_v3/index.html'),
    protocol: 'file',
    slashes: true,
  }));
...
function createMainWindow() {
  ...
  win.loadURL(formatUrl({
    pathname: path.join(__dirname, 'window_main/index.html'),
    protocol: 'file',
    slashes: true,
  }));
  win.on("closed", onMainClosed);

  let iconPath = path.join(__dirname, "static/icon-tray.png");
  if (process.platform == "linux") {
    iconPath = path.join(__dirname, "static/icon-tray@8x.png");
  }
